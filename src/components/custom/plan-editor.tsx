...
import { ArrowLeft, PlusCircle, Save, MapPin, Eye, Building, Tag, Thermometer, BatteryCharging, Calendar } from "lucide-react"; // Removed Trash2, Edit3, FileCheck, ChevronDown
